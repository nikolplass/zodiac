...
for(var i = 0; i < signs.length; i++) {
	var dropdown = document.getElementById('signslist');

	var selection = document.createElement('option');

	selection.value = signs[i].date;

	// Set the text of the button element
	selection.textContent = signs[i].date;
	
	// Append the button element to the dropdown
